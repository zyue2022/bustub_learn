...
//                         BusTub
//
// grading_executor_test_util.h
//
// Identification: test/execution/grading_executor_test_util.h
//
...
namespace bustub {
// Parameters for BIGINT index construction
constexpr static const std::size_t BIGINT_SIZE = 8;
...
// Parameters for INTEGER index construction
constexpr static const std::size_t INTEGER_SIZE = 4;
...
/**
 * The GradingExecutorTest class defines a test fixture for executor tests.
