...
public:
   ...
   */
    static auto Add(const RowMatrix<T> *matrixA, const RowMatrix<T> *matrixB)
   ...
   */
    static auto Multiply(const RowMatrix<T> *matrixA, const RowMatrix<T> *matrixB)
        -> std::unique_ptr<RowMatrix<T>> {
        // TODO(P0): Add implementation
        // 必须A的列数 == B的行数
   ...
   */
    static auto GEMM(const RowMatrix<T> *matrixA, const RowMatrix<T> *matrixB,
        ...
        if (matrixA->GetRowCount() != matrixC->GetRowCount() ||
